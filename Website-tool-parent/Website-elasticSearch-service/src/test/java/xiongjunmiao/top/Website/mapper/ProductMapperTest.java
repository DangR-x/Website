...
import xiongjunmiao.top.Website.repository.EsRepository;
...
//    private ElasticsearchTemplate elasticsearchTemplate;
    ...
    @Test
    public void testEsProductMapping() throws Exception{
        //创建索引
...
//        product.setId(1L);
//        product.setName("hahaha");
//        EsProduct save = repository.save(product);
...
//        GetRequest getRequest = new GetRequest( "book", "10");
//        //禁用获取_source
