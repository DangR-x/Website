package xiongjunmiao.top.Website.uitl.webtokenFilter.encryptionutils;
...
public class AESCipher {
    ...
    public static void main(String[] args) {
        ...
        map.put("key","1");
        map.put("hah","hehe");
        System.out.println( AESCipher.encrypt(JSONObject.toJSONString(map)));
        System.out.println(AESCipher.decrypt("N30NJ5tytVm0XANSAoLKCsR03/BfHMHKeluNObc1JvhKC2SsAm8Ah9ec35KbFt/vMLne7GnnmOEkbubdKr9sFSI965v+VIpc21TnHuuZHtY="));
    }
