...
import xiongjunmiao.top.Website.sensitivefilterutils.util.exceptionutil.MyRuntimeException;
    ...
    */
    public static int compare(String val1,String val2) {
        if (isContainTrimBlank(val1, val2))
            throw new MyRuntimeException("对比的值不能为空");
